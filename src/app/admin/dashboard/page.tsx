          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white font-medium py-2 px-4 rounded text-sm sm:text-base transition-colors"
              >
              ...
              <button 
                ...
                disabled={downloading !== null}
                className="w-full bg-green-500 hover:bg-green-600 disabled:bg-green-300 text-white font-medium py-2 px-4 rounded text-sm sm:text-base transition-colors"
              >
              ...
              <button 
                ...
                disabled={downloading !== null}
                className="w-full bg-purple-500 hover:bg-purple-600 disabled:bg-purple-300 text-white font-medium py-2 px-4 rounded text-sm sm:text-base transition-colors"
              >
              ...
              <button 
                ...
                disabled={downloading !== null}
                className="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-orange-300 text-white font-medium py-2 px-4 rounded text-sm sm:text-base transition-colors"
              >
